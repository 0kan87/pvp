...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO vpvplist (id, baslik, durum, link, servertipi, uridium, yayinlanmadurumu) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
mysql_select_db($database_baglan, $baglan);
$query_pvpekle = "SELECT * FROM vpvplist";
